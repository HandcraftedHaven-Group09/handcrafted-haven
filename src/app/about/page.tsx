export default function Page() {
  return (
    <div style={{ padding: '1rem', width: '100%' }}>
      <div className="center-children" style={{ maxWidth: '20rem' }}>
        <h2>About Us</h2>
        <p style={{ textAlign: 'justify' }}>
          Welcome to Handcrafted Haven, the online marketplace dedicated to
          showcasing unique, high-quality handcrafted products from talented
          artisans and sellers. Our mission is to support independent creators
